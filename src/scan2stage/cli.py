...
def main() -> None:
    ...
    if suffix in MESH_EXTENSIONS:
        ...
        report = process_mesh(args.input, args.output_dir, sample_count=args.samples, source_up=args.source_up, unit_scale=unit_scale, room_normalize=not args.skip_room)
    else:
